...
const FacultyLogin = () => {
  ...
  const { facultyLogin } = useContext(UserContext);
      ...
      <div className="w-full md:w-1/2 flex flex-col items-center justify-center p-8">
        <div className="w-full max-w-md bg-white rounded-lg shadow-lg p-8">
          <div className="text-center mb-8">
            ...
            />
            <div className="p-4 bg-brand-green rounded-md">
              <h1 className="text-3xl font-bold text-brand-white font-roboto">
                Faculty
              </h1>
            </div>
